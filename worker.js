// ================================================================
// 🚀 AJ SPORTS 2026 - WORKER نهایی (بدون KV برای Rate Limiting)
// ================================================================
...
export default {
  async fetch(request, env, ctx) {
    ...
    // ۱. Rate Limiting (فقط RAM - بدون KV)
    ...
    // ۲. Cache (RAM + KV فقط برای داده‌های مهم)
    if (method === 'GET') {
      ...
      // KV Cache (فقط برای داده‌های با TTL بالا)
      try {

// ================================================================
// 🚀 WORKER نهایی با مسیریابی کامل همه APIها
// ================================================================
...
function getTTL(path) {
  ...
  if (path.startsWith('/api/notifications')) return 30;
  if (path.startsWith('/api/bookmarks')) return 30;
  if (path.startsWith('/api/dm/list')) return 15;
  return 30;
}
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (isWriteMethod || isSocketIO || isUpload || isAuth || isFollow || isBlock || isReport || isSettings || isAdmin || isFootball) {
      ...
      return fetch(env.RENDER_URL + url.pathname + url.search, {
        method: method,
        headers: headers,
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // 📡 Proxy به Render (با هدرهای کامل)
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    ...
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
    // 💾 ذخیره در Cache (فقط GET های موفق)
    // ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

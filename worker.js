// ================================================================
// 🚀 AJ SPORTS 2026 - WORKER نهایی با مسیریابی کامل
// ================================================================
...
export default {
  async fetch(request, env, ctx) {
    ...
    const isHealth = url.pathname.startsWith('/api/health');
    
    // Write/Upload/Auth/Socket → مستقیماً به Render (بدون کش)
    if (isWriteMethod || isSocketIO || isUpload || isAuth || isHealth) {
      // هدرهای اصلی را به Render بفرست (Authorization, Cookie)
